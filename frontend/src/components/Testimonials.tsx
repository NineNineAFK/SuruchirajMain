                  ...
                  return (
                    <SwiperSlide
                      ...
                      className={`h-[380px] flex flex-col justify-between rounded-xl 
                        p-6 text-left text-orange-100 dark:text-white border border-black/10 dark:border-white/30
                        shadow-[0_0_10px_rgba(0,0,0,0.1)] dark:shadow-[0_0_10px_rgba(255,255,255,0.3)] transition-all duration-500
                        ${
                          isActive
                            ? 'bg-[#6d7166] dark:bg-gradient-to-br dark:from-[#2e0545] dark:to-[#541d7a] backdrop-blur-lg'
