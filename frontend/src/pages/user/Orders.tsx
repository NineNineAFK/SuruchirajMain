            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {orders.map((order) => (
                <div
                  ...
                  className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-4 md:p-6 shadow-lg text-white max-w-3xl w-full">
                  ...
                  <div className="flex space-x-4 mb-4">
                    <div className="flex items-center space-x-2">
                      <span className="text-sm font-medium font-body text-gray-100">Payment:</span>
                      <span className={`text-sm font-body font-medium ${getStatusColor(order.paymentStatus)}`}>
                        {getStatusText(order.paymentStatus)}
                      </span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="text-sm font-medium font-body text-gray-100">Delivery:</span>
          ...
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-black font-body rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                ...
                {/* Order Header */}
                <div className="bg-black p-4 border border-white/20 rounded-2xl mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div className="bg-black p-4 border border-white/20 rounded-2xl">
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-4">
                    {selectedOrder.items.map((item, index) => (
                      <div key={index} className="flex justify-between items-center bg-black">
                        <div>
