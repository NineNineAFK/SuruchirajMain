  ...
  return (
    <div className="bg-east-side-100 dark:bg-black text-black dark:text-white min-h-screen transition-colors duration-300">
      <div className="px-4 sm:px-8 py-10 max-w-5xl mx-auto font-body">
        ...
        <h2 className="text-xl font-semibold text-east-side-900 dark:text-yellow-400 mt-8 mb-2">Customer Support</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          Need help with your order or have a general query? Reach out to our friendly support team.
        </p>

        <h2 className="text-xl font-semibold text-east-side-900 dark:text-yellow-400 mt-6 mb-2">✍️ Drop Us a Message</h2>
        <form className="space-y-4">
          ...
          <button type="submit" className="w-full dark:bg-yellow-400 bg-east-side-700 text-black font-semibold py-2 rounded hover:bg-east-side-600 transition">
            Send Message
          </button>
        </form>

        <h2 className="text-xl font-semibold text-east-side-900 dark:text-yellow-400 mt-6 mb-2">Business Inquiries</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-xl font-semibold text-east-side-900 dark:text-yellow-400 mt-6 mb-2">Feedback & Suggestions</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          We value your input. If you have ideas or suggestions to help us improve, don’t hesitate to let us know.
        </p>

        <h2 className="text-xl font-semibold text-east-side-900 dark:text-yellow-400 mt-6 mb-2">Social Media</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <ul className="list-none space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          <li className="flex items-center space-x-2">
            <FaInstagram className="text-east-side-900 dark:text-yellow-400 text-lg" />
            <a
          ...
          <li className="flex items-center space-x-2">
            <FaFacebookF className="text-east-side-900 dark:text-yellow-400 text-lg" />
            <a
          ...
          <li className="flex items-center space-x-2">
            <FaLinkedinIn className="text-east-side-900 dark:text-yellow-400 text-lg" />
            <a
        ...
        <h2 className="text-xl font-semibold text-east-side-900 dark:text-yellow-400 mt-6 mb-2">Our Office Address</h2>
        ...
        {/* Embedded Google Map */}
        <h2 className="text-xl font-semibold text-east-side-900 dark:text-yellow-400 mt-6 mb-2">Our Location on Map</h2>
        <div className="mb-10">
          <iframe
