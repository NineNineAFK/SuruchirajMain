  ...
  return (
    <div className="bg-white dark:bg-black text-black dark:text-white min-h-screen transition-colors duration-300">
      <div className="px-4 sm:px-8 py-10 max-w-5xl mx-auto font-body">
        ...
        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-8 mb-2">1. Customer Support</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          Need help with your order or have a general query? Reach out to our friendly support team.
        </p>

        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-6 mb-2">✍️ Drop Us a Message</h2>
        <form className="space-y-4">
          <div>
            <label className="block text-gray-700 dark:text-gray-300 mb-1" htmlFor="name">Name</label>
            <input id="name" type="text" className="w-full px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded text-black dark:text-white" placeholder="Your name" />
          </div>
          <div>
            <label className="block text-gray-700 dark:text-gray-300 mb-1" htmlFor="email">Email</label>
            <input id="email" type="email" className="w-full px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded text-black dark:text-white" placeholder="you@example.com" />
          </div>
          <div>
            <label className="block text-gray-700 dark:text-gray-300 mb-1" htmlFor="message">Message</label>
            <textarea id="message" rows={5} className="w-full px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded text-black dark:text-white" placeholder="How can we help?" />
          </div>
        ...
        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-6 mb-2">2. Business Inquiries</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-6 mb-2">3. Feedback & Suggestions</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          We value your input. If you have ideas or suggestions to help us improve, don’t hesitate to let us know.
        </p>

        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-6 mb-2">4. Social Media</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <ul className="list-none space-y-3 text-gray-700 dark:text-gray-300 mb-6">
          <li className="flex items-center space-x-2">
            <FaInstagram className="text-yellow-600 dark:text-yellow-400 text-lg" />
            <a
          ...
          <li className="flex items-center space-x-2">
            <FaFacebookF className="text-yellow-600 dark:text-yellow-400 text-lg" />
            <a
          ...
          <li className="flex items-center space-x-2">
            <FaLinkedinIn className="text-yellow-600 dark:text-yellow-400 text-lg" />
            <a
        ...
        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-6 mb-2">5. Our Office Address</h2>
        ...
        {/* Embedded Google Map */}
        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-6 mb-2">6. Our Location on Map</h2>
        <div className="mb-10">
          <iframe
