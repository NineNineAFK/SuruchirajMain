    ...
    <div className="bg-white dark:bg-black text-black dark:text-white min-h-screen transition-colors duration-300">
      <div className="min-h-screen px-4 sm:px-8 py-10 max-w-5xl mx-auto font-body">
        ...
        <p className="mb-6 text-gray-700 dark:text-gray-300">
          Welcome to <span className="text-yellow-600 dark:text-yellow-400 font-semibold">Suruchiraj Spices</span>! These Terms and Conditions outline the rules and regulations for the use of our website and the purchase of our products.
        </p>
        ...
        <Section title="6. Order Acceptance and Payment">
...
const Section = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="mb-6">
    <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-10 mb-2">{title}</h2>
