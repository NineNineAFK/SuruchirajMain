    ...
    <div className="bg-east-side-100 dark:bg-black text-black dark:text-white min-h-screen transition-colors duration-300">
      <div className="min-h-screen px-4 sm:px-8 py-10 max-w-5xl mx-auto font-body">
        ...
        <p className="mb-6 text-gray-700 dark:text-gray-300">
          At <strong className="text-text-[#4D6A3F] dark:text-yellow-400">Suruchiraj Spices</strong>, your privacy is of utmost importance to us.
          This Privacy Policy outlines how we collect, use, maintain, and disclose information from users of our website.
        </p>

        <h2 className="text-xl font-semibold text-[#4D6A3F] dark:text-yellow-400 mt-10 mb-2">Information We Collect</h2>
        ...
        <h2 className="text-xl font-semibold text-[#4D6A3F] dark:text-yellow-400 mt-10 mb-2">How We Use Collected Information</h2>
        ...
        <h2 className="text-xl font-semibold text-[#4D6A3F] dark:text-yellow-400 mt-10 mb-2">How We Protect Your Information</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-xl font-semibold text-[#4D6A3F] dark:text-yellow-400 mt-10 mb-2">Sharing Your Personal Information</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-xl font-semibold text-[#4D6A3F] dark:text-yellow-400 mt-10 mb-2">Cookies and Tracking Technologies</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-xl font-semibold text-[#4D6A3F] dark:text-yellow-400 mt-10 mb-2">Your Rights</h2>
        <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 mb-4">
        ...
        <h2 className="text-xl font-semibold text-[#4D6A3F] dark:text-yellow-400 mt-10 mb-2">Changes to This Policy</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-xl font-semibold text-[#4D6A3F] dark:text-yellow-400 mt-10 mb-2">Your Acceptance of These Terms</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-xl font-semibold text-[#4D6A3F] dark:text-yellow-400 mt-10 mb-2">Contacting Us</h2>
