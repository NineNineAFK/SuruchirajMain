    ...
    <div className="bg-white dark:bg-black text-black dark:text-white min-h-screen transition-colors duration-300">
      <div className="min-h-screen px-4 sm:px-8 py-10 max-w-5xl mx-auto font-body">
        ...
        <p className="mb-6 text-gray-700 dark:text-gray-300">
          At <span className="text-yellow-600 dark:text-yellow-400 font-semibold">Suruchiraj Spices</span>, we're committed to getting our flavorful products to your doorstep efficiently. This policy outlines our shipping and delivery procedures, both domestically and internationally.
        </p>

        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-10 mb-2">1. Shipping Carriers</h2>
        ...
        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-10 mb-2">2. Order Processing and Dispatch</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-10 mb-2">3. Delivery Liability and Address Accuracy</h2>
        <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 mb-4">
          ...
          <li><span className="font-semibold">Incorrect Address:</span> Non-delivery or re-shipping due to wrong addresses will be at the customer’s expense.</li>
        ...
        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-10 mb-2">4. International Shipments: Customs, Duties, and Taxes</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-10 mb-2">5. Delivery Confirmation and Tracking</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-2xl font-semibold text-yellow-600 dark:text-yellow-400 mt-10 mb-2">6. Assistance and Support</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
